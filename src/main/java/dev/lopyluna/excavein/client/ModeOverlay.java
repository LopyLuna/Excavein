...
import dev.lopyluna.excavein.config.ClientConfig;
import dev.lopyluna.excavein.entries.ExcaveinEntries;
import dev.lopyluna.excavein.utils.Utils;

import java.awt.*;

import static dev.lopyluna.excavein.client.BlockOutlineRenderer.amountBreak;
import static dev.lopyluna.excavein.client.BlockOutlineRenderer.amountInteract;
import static dev.lopyluna.excavein.client.ClientHandler.SELECTION_ACTIVATION;
import static dev.lopyluna.excavein.client.ClientHandler.keyPressed;
import static dev.lopyluna.excavein.config.ClientConfig.*;
import static dev.lopyluna.excavein.config.ServerConfig.*;
import static dev.lopyluna.excavein.utils.Utils.OffsetTime.SECONDS;
